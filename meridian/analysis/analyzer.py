...
class Analyzer:
  ...
  def incremental_outcome(
    ...
    # Verify geo and channel dimensions of new data.
    ...
    # Verify time dimensions of new data.
    ...
    if use_flexible_time:
      # Validate `selected_times` and `media_selected_times`.
